    ...
    <div class="box2">
      ...
      <div class="box3">
        <div class="box3-1" id="el">
          <div
            v-for="(item, index) in stores.msgList"
            :key="index"
            class="box3-1-item"
          ...
          >
            ...
            <div class="box3-1-item-box">
              <div class="box3-1-item-box-name">
                {{ item.uuid === stores.user.uuid ? "" : item.name }}
              </div>
      ...
      <div class="box4">
        <div class="box4-1" id="log">
          <div v-for="(item, index) in stores.logList" :key="index" class="box4-1-item">
            {{ item }}
          </div>
        </div>
        <div class="box4-2">
